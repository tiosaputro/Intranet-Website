...
class NewsController extends Controller
{
    ...
    public function __construct(NewsServices $services)
    {
        ...
        $this->dirView  = 'admin.content';
        $this->route = 'backend/management-content';
    ...
    public function store(Request $request)
    {
        ...
        if (isset($request->broadcast) && $request->broadcast == "on") {
            ...
            $body = 'New ' . $channelName . ' ' . $judul;
            $data = json_encode(array('event' => url('content/detail/' . $category . '/' . $id)));
