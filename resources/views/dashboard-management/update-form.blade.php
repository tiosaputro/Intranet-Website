                            ...
                            <div class="card-body">
                                <form action="{{ url('backend/dashboard/filter') }}" class="form-group" method="GET">
                                    <div class="row mt-2">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="pd-default"
                                                    ...
                                                    value="{{ $filterDate }}" placeholder="{{ date('Y-m-d') }}" />
                                            </div>
                                        </div>
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <select name="bu" id="business_unit" class="form-control select2">
                                                    ...
                                                    @foreach ($bu as $rowBu)
                                                        <option value="{{ $rowBu->id }}"
                                                            {{ $rowBu->id == $filterBu ? 'selected' : '' }}>
                                                            {{ $rowBu->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-md-2">
                                            <button class="btn btn-md btn-primary form-control mt-2 text-sm" type="submit">
                        ...
                        <div class="card">
                            ...
                            <form action="{{ url('backend/dashboard/save-daily') }}" method="POST">
                                <input type="hidden" name="date"
                                    value="{{ empty($filterDate) ? date('Y-m-d H:i:s') : $filterDate }}"
                                    class="form-control" />
                                <div class="card-header border-top-success p-1 border-3">
                                    ...
                                    @if ($inputBudget)
                                        <a href="{{ url('backend/dashboard/add-budget') }}"
                                            ...
                                            Daily</a>
                                    @else
                                        <a href="{{ url('backend/dashboard/filter-budget?date=' . $filterDate . '&bu=') }}"
                                            class="btn btn-sm btn-primary"><i data-feather="eye"></i> Show Budget
                                            {{ $filterDate }}</a>
                                    @endif
                                    <h4 class="text-end">{{ \Carbon\Carbon::parse($filterDate)->format('d M Y h:i:s') }}
                                    </h4>
                                </div>
                                <div class="card-body">
