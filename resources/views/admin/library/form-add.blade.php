            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="pt-0 form" enctype="multipart/form-data" id="image-upload-preview" action="{{ url($route.'/store') }}"" method="POST">
                                @csrf()
                          <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-1">
                                            <label class="form-label fw-bold">SOP Number</label>
                                                <input class="form-control" type="text" name="sop_number" value="{{ old('sop_number') }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-1">
                                            <label class="form-label fw-bold">Rev No</label>
                                                <input class="form-control" type="number" name="rev_no" value="{{ old('rev_no') }}">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-1 position-relative">
                                            ...
                                            <input type="text" class="form-control pickadate-months-year" name="issued" value="{{ old('issued') }}" placeholder="YYYY-MM-DD" />
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-1 position-relative">
                                            ...
                                            <input type="text" class="form-control pickadate-months-year" name="expired" value="{{ old('expired') }}" placeholder="YYYY-MM-DD" />
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-1">
                                            <label class="form-label fw-bold">Tags Relation Document (Press Comma (,))</label>
                                                <input class="form-control" type="text" name="tags_relation" value="{{ old('tags') }}">
