                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{ url('backend/management-content') }}">Knowledge Sharing</a>
                                </li>
                          ...
                          <div class="row">
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    <input type="text" class="form-control" id="title" name="title" name="title" placeholder="Title" />
                                    @if ($errors->has('title'))
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-1">
                                            ...
                                            @endif
                                            <div class="col-md-12 mb-2 mt-2">
                                                    <img id="preview-image2" class="lightboxed rounded" rel="group1" src="{{ asset('app-assets/image_not_found.gif') }}" width="120" height="120" style="max-height: 250px;" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
