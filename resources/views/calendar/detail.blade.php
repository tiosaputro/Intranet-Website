...
@section('content')
    ...
    <div class="app-content content ">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">EMP Calendar</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="/calendar">Calendar</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="#">EMP Calendar {{ strtoupper($calendar->category) }}</a>
                                    </li>
                                    <li class="breadcrumb-item active">{{ $calendar->title }}
                                    </li>
                                </ol>
                            </div>
                        </div>
                ...
                <div class="content-body">
                    ...
                    <div class="blog-detail-wrapper">
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <!-- <img :src="'../'+calendar.banner_path" class="img-fluid card-img-top" alt="Blog Detail Pic" /> -->
                                {{-- <img class="xzoom4 img-fluid card-img-top" id="xzoom-fancy" src="{{ asset($calendar->banner_path) }}" xoriginal="{{ asset($calendar->banner_path) }}" style="max-height:370px; max-width:100%; object-fit:contain;" /> --}}
                                @if(!empty($calendar->banner))
                                <a data-fancybox="gallery" data-src="{{ asset($calendar->banner) }}">
                                    <img src="{{ asset($calendar->banner) }}" class="rounded img-fluid card-img-top" data-caption="{{ $calendar->title }}" style="max-height:370px; max-width:100%; object-fit:cover;" />
                                </a>
                                @endif
                                    <div class="card-body">
                                        <h4 class="card-title"><i data-feather="calendar"></i> {{ $calendar->title }}</h4>
                                        <div class="d-flex">
                                            <div class="avatar me-50">
                                                <img src="{{ asset('app-assets/images/portrait/small/avatar.png') }}" alt="Avatar" width="24" height="24" />
                                            </div>
                                            <div class="author-info">
                                                <small class="text-muted me-25">by</small>
                                                <small><a href="#" class="text-body">{{ isset($calendar->creator->name) ? ucwords($calendar->creator->name) : '' }}</a></small>
                                                <span class="text-muted ms-50 me-25">|</span>
                                                <small class="text-muted">{{ humanDate($calendar->created_at) }}</small>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-12 content-html card-text mb-2">
                                            {{ $calendar->description }}
                                            <hr/>
                                            <div class="d-flex flex-row meetings mt-2">
                                                ...
                                                <div class="content-body">
                                                    <h6 class="mb-0">
                                                        {{ customTanggal($calendar->start_date, 'D, d M Y h:i') }} sampai {{ customTanggal($calendar->end_date, 'D, d M Y h:i') }}
                                                    </h6>
                                                    <small>{{ ($calendar->allday) ? 'All Day' : 'Some Day' }}</small>
                                                </div>
                                            </div>
                                            <div class="d-flex flex-row meetings mt-2">
                                                <div class="avatar bg-light-primary rounded me-1">
                                                ...
                                                <div class="content-body">
                                                    <h6 class="mb-0">{{ $calendar->location }}</h6>
                                                    <small>Address</small>
                                                </div>
                                            </div>
                                            ...
                                            <div class="d-flex flex-row meetings mt-2">
                                                    ...
                                                    <div class="avatar bg-light-primary rounded me-1">
                                                        <div class="avatar-content">
                                                            <i data-feather="link" class="avatar-icon font-medium-3"></i>
                                                        </div>
                                                    </div>
                                                    </a>
                                                    <a href="{{ $calendar->url }}">
                                                    <div class="content-body">
                                                        <small>Click Detail!</small>
                                                    </div>
                                                    </a>
                                            </div>
                                            @endif
                                        ...
                                        <div class="d-flex align-items-center justify-content-between">
                                            <div class="d-flex align-items-center">
                                                <div class="d-flex align-items-center me-1">
                                                    <a href="#" class="me-50 btn btn-primary" id="copyLink">
                                                        <input type="hidden" id="copyUrl" value="{{ \Request::url() }}">
                                                        <i class="font-medium-5 text-white text-body align-middle"></i> Copy Link
                                                    </a>
                                                    {{-- <a href="#">
                                            ...
                                            <div class="dropdown blog-detail-share" style="display: none;">
        ...
        @include('calendar.recent-calendar')
