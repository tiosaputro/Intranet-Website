            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">EMP {{ strtoupper($news->category) }}</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="/dashboard">Dashboard</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="#">EMP {{ strtoupper($news->category) }}</a>
                                    </li>
                ...
                <div class="content-body">
                    ...
                    <div class="blog-detail-wrapper">
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <!-- <img :src="'../'+news.banner_path" class="img-fluid card-img-top" alt="Blog Detail Pic" /> -->
                                {{-- <img class="xzoom4 img-fluid card-img-top" id="xzoom-fancy" src="{{ asset($news->banner_path) }}" xoriginal="{{ asset($news->banner_path) }}" style="max-height:370px; max-width:100%; object-fit:contain;" /> --}}
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="author-info">
                                                ...
                                                <small><a href="#" class="text-body">{{ isset($news->creator->name) ? ucwords($news->creator->name) : '' }}</a></small>
