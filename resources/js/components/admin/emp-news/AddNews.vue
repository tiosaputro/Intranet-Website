                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="#/admin-emp-news">Content EMP</a>
                                </li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    <ckeditor :editor="editor" v-model="form.content" :config="editorConfig" id="ckeditor"></ckeditor>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-12 col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    <input type="checkbox" name="status" class="checkbox" v-model="form.active"> Aktif ?
                                </div>
                            </div>
         ...
         errors : null,
          ...
          editorConfig: {
                ...
                //  plugins: [
                    ...
                    // CKFinderPlugin,
                // ],
                // toolbar: [ 'bold', 'italic', '|', 'link', 'ckfinder','html-embed','upload'],
                toolbar: {
                    items: [
                        'heading', '|',
                        'fontfamily', 'fontsize', '|',
    ...
    addModul(){
        ...
        if(this.editId == 0){
            ...
            axios.post(modul, this.form).then(response => (
                ...
                this.$swal(this.$func.notifAlert('success','Berhasil','Data News Berhasil Disimpan'))
            ))
            .catch(err=> console.log(err))
            .finally(() =>
                this.disableSubmit = false,
                this.$router.push({name: 'management-emp-'+modul}),
            )
        }
    }
  } //end methods
