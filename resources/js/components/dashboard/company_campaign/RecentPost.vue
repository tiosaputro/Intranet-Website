                ...
                <div class="sidebar">
                    <div class="blog-sidebar my-2 my-lg-0">
                        ...
                        <div class="blog-categories mt-3">
                            ...
                            <div class="mt-1">
                                <div class="d-flex justify-content-start align-items-center mb-75">
                                    ...
                                    <a href="#">
                                        <div class="blog-category-title text-body">SHE</div>
                                    </a>
                                </div>
                                <div class="d-flex justify-content-start align-items-center mb-75">
                                    <a href="#" class="me-75">
                                    ...
                                    <a href="#">
                                        <div class="blog-category-title text-body">CSR</div>
                                    </a>
                                </div>
                                <div class="d-flex justify-content-start align-items-center mb-75">
                                    <a href="#" class="me-75">
                                    ...
                                    <a href="#">
                                        <div class="blog-category-title text-body">Government</div>
                                    </a>
                                </div>
                                <div class="d-flex justify-content-start align-items-center mb-75">
                                    <a href="#" class="me-75">
                                    ...
                                    <a href="#">
                                        <div class="blog-category-title text-body">Prouction</div>
                                    </a>
                                </div>
                                <div class="d-flex justify-content-start align-items-center">
                                    ...
                                    <a href="#">
                                        <div class="blog-category-title text-body">HR</div>
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="blog-recent-posts mt-3">
                            <h6 class="section-label">Recent Posts News</h6>
                            <div class="mt-75">
