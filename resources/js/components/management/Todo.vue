...
import '/app-assets/vendors/js/pickers/flatpickr/flatpickr.min.js'
import '/app-assets/vendors/js/forms/validation/jquery.validate.min.js'
import '/app-assets/js/scripts/pages/app-todo.min.js'
